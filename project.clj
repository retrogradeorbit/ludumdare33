(defproject ludumdare33 "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {
    :builds [{:id "dev"
              ...
              :figwheel { :on-jsload "ludumdare33.core/on-js-reload" }

              :compiler {:main ludumdare33.core
                         :asset-path "js/compiled/out"
                         :output-to "resources/public/js/compiled/ludumdare33.js"
             ...
             {:id "min"
              :source-paths ["src"]
              :compiler {:output-to "resources/public/js/compiled/ludumdare33.js"
                         :main ludumdare33.core
